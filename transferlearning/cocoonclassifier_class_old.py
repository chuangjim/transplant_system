        ...
        for epoch in range(self.n_epochs):
            ...
            for param in ["train", "val"]:
                ...
                for data in self.dataloader[param]:
                    ...
                    y_pred = self.model(X)
                    y_pred_squeeze = y_pred.squeeze(1)
                    _, pred = torch.max(y_pred.data, 1)
                    # print("y_pred shape:", y_pred.shape)
                    # print("y_pred_squeeze shape:", y_pred_squeeze.shape)
...
cocoon = MODEL('vgg16', 30, 100, 'finetune')
cocoon.read_train_data("../data/delta_day_3__train_test_mix")
cocoon.train()
...
cocoon.plot()
cocoon.read_test_data("../data/delta_day_3__train_test_mix")
cocoon.test()
